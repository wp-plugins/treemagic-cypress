...
2. Target URL: Contains the URL address that will be combined with the end-user's highlighted text, This is how we query the reference site with the word(s) on the page e.g. http://www.google.com/search?hl=en&q=MyQueryWords
